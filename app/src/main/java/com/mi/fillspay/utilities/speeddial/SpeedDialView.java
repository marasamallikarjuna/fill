...
package com.mi.fillspay.utilities.speeddial;
...
import static com.mi.fillspay.utilities.speeddial.SpeedDialActionItem.RESOURCE_NOT_SET;
...
public class SpeedDialView extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEFAULT_ROTATE_ANGLE = 60;
    private static final int ACTION_ANIM_DELAY = 25;
    private static final int MAIN_FAB_HORIZONTAL_MARGIN_IN_DP = 2;
    private static final int MAIN_FAB_VERTICAL_MARGIN_IN_DP = -1;
    ...
    private Drawable getmMainFabOpenedDrawable;
    ...
    private int getLayoutPosition(int position) {
        if (getExpansionMode() == ExpansionMode.TOP || getExpansionMode() == ExpansionMode.LEFT) {
    ...
    private SpeedDialActionItem removeActionItem(@Nullable FabWithLabelView view,
                                                 @Nullable Iterator<FabWithLabelView> it, boolean animate) {
        if (view != null) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            @DrawableRes
            int openDrawableRes = styledAttrs.getResourceId(R.styleable.SpeedDialView_sdMainFabClosedSrc,
                    RESOURCE_NOT_SET);
    ...
    @Retention(SOURCE)
    @IntDef({ExpansionMode.TOP, ExpansionMode.BOTTOM, ExpansionMode.LEFT, ExpansionMode.RIGHT})
