...
public class MarshMallowPermission {
    ...
    public static final int BLUETOOTH_PERMISSION_REQUEST_CODE=4;
    ...
    public void requestPermissionForBluetooth(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.BLUETOOTH)){
            ...
            ActivityCompat.requestPermissions(activity,new String[]{Manifest.permission.BLUETOOTH},BLUETOOTH_PERMISSION_REQUEST_CODE);
        }
    }
    ...
    public void requestPermissionForContact(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_CONTACTS)){
            ...
            ActivityCompat.requestPermissions(activity,new String[]{Manifest.permission.READ_CONTACTS},CAMERA_PERMISSION_REQUEST_CODE);
        }
    }
